...
% 8. Histograms are plotted for each season displaying the refrence time 
...
text(0.52, 0.98,"Distribution of monthly mean surface temperature anomalies \
over the Australian mainland and Tasmania during austral summer", ...
...
"Visible", "off", "Units", "normalized", "clipping", "off");
text(0.52, 0.98,"Distribution of monthly mean surface temperature anomalies \
over the Australian mainland and Tasmania during austral autumn", ...
"HorizontalAlignment", "center", "VerticalAlignment", "top",'fontsize', 16);
...
"Visible", "off", "Units", "normalized", "clipping", "off");
text(0.52, 0.98,"Distribution of monthly mean surface temperature anomalies \
over the Australian mainland and Tasmania during austral winter", ...
"HorizontalAlignment", "center", "VerticalAlignment", "top",'fontsize', 16);
...
"Visible", "off", "Units", "normalized", "clipping", "off");
text(0.52, 0.98,"Distribution of monthly mean surface temperature anomalies \
over the Australian mainland and Tasmania during austral spring", ...
"HorizontalAlignment", "center", "VerticalAlignment", "top",'fontsize', 16);
